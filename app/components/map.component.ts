...
export class MapComponent implements AfterViewInit {
    ...
    this.sensorsSharedService.getGps().subscribe((payloads: ARF8084BAPayload[]) => {
      ...
      payloads.forEach(payload => {
        ...
        if (payload.longtitude != undefined && payload.latitude != undefined) {
         ...
         setTimeout(() => {
            console.log("kreslim ", payload.latitude, payload.longtitude);
            // console.log(payload.longtitude, payload.latitude);
            // list.push({location: new google.maps.LatLng(payload.latitude, payload.longtitude), weight: 10 });
            // list.push(new google.maps.LatLng(payload.latitude, payload.longtitude));
            ...
            let marker = new google.maps.Marker({
              position: new google.maps.LatLng(payload.latitude, payload.longtitude),
              map: this.map,
            ...
            //   fillOpacity: 0.35,
            //   map: this.map,
            //   center: new google.maps.LatLng(payload.latitude, payload.longtitude),
            //   radius: 10000,
            // })
              }, 1000 * i++);
        }
      ...
      // this.points = list;
      // console.log("gps published", list);
  ...
  getPoints2() {
    return [
      { location: new google.maps.LatLng(50.052195, 14.439278), weight: 10 },
      { location: new google.maps.LatLng(50.052400, 14.439053), weight: 10 },
      { location: new google.maps.LatLng(50.052717, 14.438737), weight: 11 },
      { location: new google.maps.LatLng(50.052920, 14.439069), weight: 4 },
      { location: new google.maps.LatLng(50.053020, 14.439359), weight: 3 },
      { location: new google.maps.LatLng(50.052793, 14.439622), weight: 2 },
      { location: new google.maps.LatLng(50.052524, 14.439697), weight: 1 },
      { location: new google.maps.LatLng(50.052349, 14.440008), weight: 0.5 },
      { location: new google.maps.LatLng(50.052200, 14.439649), weight: 0.5 },
      { location: new google.maps.LatLng(50.052349, 14.440008), weight: 0.5 },
      { location: new google.maps.LatLng(50.052200, 14.439649), weight: 0.5 },
      { location: new google.maps.LatLng(50.052349, 14.440008), weight: 0.5 },
      { location: new google.maps.LatLng(50.052200, 14.439649), weight: 0.5 },
      { location: new google.maps.LatLng(50.052349, 14.440008), weight: 12 },
      { location: new google.maps.LatLng(50.052200, 14.439649), weight: 15 }
    ]
  }
