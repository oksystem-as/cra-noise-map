...
@Component({
  ...
  template: `<div id="aboutAppId">
	<button type="button" class="btn btn-primary aboutAppButton" (click)="onAboutAppClick()" 
		tooltip="O aplikaci" tooltipPopupDelay="1500" tooltipPlacement="left"> 
