...
export class SensorsSharedService {
    ...
    public sensorMetaData: { position: number, devEUI: string, latitude: number, name: string, longtitude: number, latitudeText: string, longtitudeText: string }[] = [
        // MOCK
        { position: 3, devEUI: "0004A30B0019D0EB", name: "OKsystem (fiktivní) ",   latitude: 50.052853, longtitude: 14.439492, latitudeText: "50°03'10.3\"", longtitudeText: "14°29'22.2\"" },
        { position: 4, devEUI: "0004A30B0019D0EC", name: "Lumírova (fiktivní)",    latitude: 50.063224, longtitude: 14.423984, latitudeText: "50°03'47.6\"", longtitudeText: "14°25'26.3\"" },
        ...
        // real
        { position: 0, devEUI: "0004A30B0019D0EA", name: "Náměstí Bratří Synků", latitude: 50.064227, longtitude: 14.441406, latitudeText: "50°03'51.2\"", longtitudeText: "14°26'29.1\"" },
        ...
        { position: 2, devEUI: "0004A30B0019B1CA", name: "Bělohorská          ", latitude: 50.084542, longtitude: 14.376329, latitudeText: "50°04'54.4\"", longtitudeText: "14°21'15.5\"" },
